...
export const metadata = {
  ...
  alternates: { canonical: "/transport/taipei/airport-to-taipei" },
};
    ...
    <main>
      <BreadcrumbSchema
        items={[
          ...
          { name: "Airport to Taipei Main", href: "/transport/taipei/airport-to-taipei" },
        ]}
      />
      <ArticleSchema
        ...
        url="/transport/taipei/airport-to-taipei"
